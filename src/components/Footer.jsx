...
const Footer = ({ data }) => {
  return (
    <footer className="bg-primary text-light/80 pt-10 w-full">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        
        {/* Brand Profile */}
        <div>
          <h4 className="text-white font-bold text-lg mb-6 tracking-wide">BRAND PROFILE</h4>
        ...
        {/* Help */}
        <div>
          <h4 className="text-white font-bold text-lg mb-6 tracking-wide">HELP</h4>
          <ul className="space-y-3">
        ...
        {/* Trust Badges */}
        <div>
          <h4 className="text-white font-bold text-lg mb-6 tracking-wide">WE GUARANTEE</h4>
          <div className="flex flex-col gap-4">
            {data.trust_badges.map((badge, idx) => (
              <div key={idx} className="flex items-center gap-3 bg-white/5 py-3 px-4 rounded-md border border-white/10">
                ...
                <span className="font-semibold text-white tracking-wider text-sm">{badge}</span>
              </div>
            ))}
          </div>
        </div>
